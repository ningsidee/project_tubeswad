<nav class="d-flex flex-column align-items-center align-items-sm-start position-fixed bg-body-tertiary start-0 top-0 mb-5 rounded p-3 text-white shadow"
    ...
    @else
        ...
        <ul class="nav flex-column w-100">
            ...
            <!-- Health Indicator -->
            <li class="nav-item {{ Route::is('indikator-kesehatan.index') ? 'fw-bold' : '' }} mb-3">
                <a href="{{ route('indikator-kesehatan.index') }}" class="nav-link d-flex align-items-center"
                    style="color: #4B0082;">
            ...
            <!-- Daily Activity -->
            <li class="nav-item {{ Route::is('aktivitas_harian.index') ? 'fw-bold' : '' }} mb-3">
                <a href="{{ route('aktivitas_harian.index') }}" class="nav-link d-flex align-items-center"
                    style="color: #4B0082;">
